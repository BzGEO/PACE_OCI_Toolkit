...
## Updates: 28.08.2026
1. Having acquired PACE OCI monthly composites for [surface reflectance](https://pace.oceansciences.org/pace_sfrefl.htm) and vegetation indices, we are in the process of extracting the data as GeoTIFF, and importing that data into GEE.
